...
function loadCourses() {
  ...
  .catch(error => {
      ...
      showNotification("error", "Erreur lors du chargement des cours.", "Action échouée");
  });
  }
  ...
  document.addEventListener("click", function (e) {
    if (e.target.closest(".btn-edit")) {
      ...
      axios.get(CONFIG.BASE_URL + `/api/courses/${coursId}/`, {
        ...
        showNotification("error", "Erreur lors du chargement du cours.", "Action échouée");
      });
    }
  });
      ...
      axios.get(CONFIG.BASE_URL + `/api/courses/${coursId}/`, {
        headers: {
          ...
          .then(response => {
            ...
            document.getElementById("descriptions-cours").textContent = cours.descriptions;
            ...
            document.getElementById("meeting_link-cours").innerHTML = `<a class="text-white" href="${cours.meeting_link}" target="_blank"><i class="fa fa-link "></i> Lien du cours</a>`;
            document.getElementById("pdf-cours").innerHTML = `<a class=" text-white" href="${cours.pdf}" target="_blank"><i class="fa fa-download"></i> Télécharger le cours</a>`;
